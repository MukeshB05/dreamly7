...
export const MOVIE_STUDIOS = [
  ...
  { id: 127162, name: 'Wayfarer Films', logo: '/77iHxiuXJYTXKU4PDQmtRQe3DJx.png', preserveColor: false },
  { id: 16401, name: 'Aashirvad Cinemas', logo: '/khS7G0KzBoCYcLs4xuNjpuZjntR.png', preserveColor: false },
